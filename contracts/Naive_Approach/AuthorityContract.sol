...
contract AuthorityContract is AccessControl{
    ...
    // Constructor 
        ...
        function setUpFactory(address _mf,address _lf, address _af)public {
            manufacturerFactory = ManufacturerFactory(_mf);
            laboratoryFactory =  LaboratoryFactory(_lf);
            accreditorFactory =  AccreditorFactory(_af);
        }
